...
const ServiceHeading = () => {
    return (
        <div className="mb-5 mx-5" style={{ marginTop: "-5rem" }}>
            <div className="row">
                <div className="col">
                    <div className="card shadow text-center rounded">
                        <div>
                        ...
                        <div className="card-body bg-secondary">
                            ...
                            <p className="card-text text-white">Some quick example text to build on the card title and make up the bulk of the cards content.lorem10  the bulk of the cards content.lorem10  the bulk of the cards content.lorem10  the bulk of the cards content.lorem10</p>
